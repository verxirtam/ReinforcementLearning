...
}
{
	...
	MeanCostMean=MeanCostSum/N;
	MeanCostUV=MeanCostSq/(N-1)-MeanCostMean*MeanCostMean*N/(N-1);
	MeanCostIntWidth2=TDist95Point[N-1]*sqrt(MeanCostUV)/sqrt(N);
	MeanCostIntMin=MeanCostMean-MeanCostIntWidth2;
	MeanCostIntMax=MeanCostMean+MeanCostIntWidth2;
	#print MeanCostMean" "MeanCostUV" "sqrt(MeanCostUV)" ["MeanCostIntMin", "MeanCostIntMax"]";

	#print "["CostIntMin/MeanCostIntMax", "CostIntMax/MeanCostIntMin"]";
	print MeanCostMean"\t"MeanCostIntMin"\t"MeanCostIntMax;
	#################################################
}
END{
} 
